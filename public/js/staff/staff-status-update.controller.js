module.exports = function(app){
  ...
  /*@ngInject*/
app
    .controller('StaffStatusUpdateController', StaffStatusUpdateController);

  /*@ngInject*/
  function StaffStatusUpdateController($scope, $log, $rootScope, moment, toastr, StaffService, $modal, StaffList){
    $log.log($scope);
    var vm = this;
